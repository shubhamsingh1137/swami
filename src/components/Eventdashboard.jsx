...
const Eventdashboard = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-r from-orange-300 via-yellow-50 to-pink-300 py-10 px-4 lg:px-30">
      ...
      <div className="bg-orange-300 shadow-lg rounded-xl p-6 max-w-5xl mx-auto mb-12 border-l-4 border-gray-800 hover:scale-105 transition-transform duration-500 ease-in-out">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 max-w-5xl mx-auto">
          {paginatedData.length > 0 ? (
            paginatedData.map((event, index) => (
              ...
              >
                {/* Image */}
                <div className="h-48 w-full overflow-hidden hover:scale-105 transition-transform duration-500 ease-in-out">
                  <img
                ...
                {/* Content */}
                <div className="p-4 flex flex-col flex-1 justify-between hover:scale-105 transition-transform duration-500 ease-in-out">

  ...
  return (
    <div className="w-full min-h-screen overflow-x-hidden flex justify-center p-4 sm:p-6  ">
      <div className="w-full max-w-4xl space-y-8 lg:mx-40">
        ...
        {/* Profile Header */}
        <div className="bg-orange-300 rounded-xl shadow-lg p-4 sm:p-6 flex flex-col sm:flex-row items-center sm:items-start justify-between gap-4 sm:gap-6 hover:scale-105 transition-transform duration-500 ease-in-out w-full">
          {/* Profile Info */}
          <div className="flex flex-col sm:flex-row items-center gap-4 sm:gap-6 w-full sm:w-auto">
            <div className="w-12 h-12 sm:w-16 sm:h-16 bg-orange-400 rounded-full flex items-center justify-center text-white text-xl sm:text-2xl font-bold uppercase">
          ...
          <div className="w-full sm:w-auto flex justify-center sm:justify-end">
            <button
              ...
              className="flex items-center space-x-2 px-4 py-2 bg-yellow-500 hover:bg-yellow-400 text-gray-900 rounded-lg font-medium hover:scale-105 transition-transform duration-300 ease-in-out"
            >
              <EditIcon />
              <span>Edit</span>
            </button>

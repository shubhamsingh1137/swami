  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-gradient-to-r from-orange-300 via-yellow-50 to-pink-300 py-10 px-4 sm:px-6 lg:px-35 ">
        <div className="bg-white/70  rounded-xl shadow-2xl p-6 sm:p-10 max-w-5xl mx-auto mb-12 hover:scale-105 transition-transform duration-500 ease-in-out">
        ...
        <div className="text-center mb-8">
          <h2 className="text-4xl font-extrabold text-gray-800 underline underline-offset-4 hover:scale-105 transition-transform duration-500 ease-in-out">
            Edit Profile
          </h2>
        </div>

        <div className="bg-white/70 backdrop-blur-lg p-6 sm:p-10 rounded-2xl shadow-xl max-w-5xl mx-auto hover:scale-105 transition-transform duration-500 ease-in-out">
          <form
